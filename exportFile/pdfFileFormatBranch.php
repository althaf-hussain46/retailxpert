...
$querySearch = "SELECT * FROM branches WHERE branch_name LIKE '%$searching_name1%' && id = '$branchId'";
...
$pdf->SetTextColor(0, 51, 102); // Dark blue
$pdf->Cell(0, 10, 'Branches Report', 0, 1, 'C');
$pdf->Ln(5);
...
$columns = [10, 50, 130, 100, 30]; // Adjusted column widths
$headers = ['S.No', 'Branch Name', 'Address', 'Contacts', 'GST NO.'];
...
if ($searchResult && $searchResult->num_rows > 0) {
    ...
    while ($data = $searchResult->fetch_assoc()) {
        ...
        // GST No.
        $pdf->Cell($columns[4], $rowHeight, $data[$PANORGST], 1, 1, 'L');
