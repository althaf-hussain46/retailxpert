...
<?php 
  ...
  if(isset($_POST['get_item_f4'])){
    ...
    if(isset($_POST['lb_product_value']) && isset($_POST['lb_brand_value']) && isset($_POST['lb_design_value'])
...
<body>
    ...
    <div id="message" >
        ...
        <form action=""  style="position:absolute;z-index:1000;width:200px;max-height:200px;overflow-x:auto;overflow-y:auto;" id="myform"
        onkeypress="">
...
font-size: 10px;
  ...
  <form style="position:absolute;top:170px;left:400px;z-index:1000;background-color: #FF3CAC;background-image: linear-gradient(225deg, #FF3CAC 0%, #784BA0 50%, #2B86C5 100%);">
  <div style="max-height: 300px; overflow-y: auto; width: 750px;">
    <table id="itemInformationTable" class="table" style="width: 100%; table-layout: fixed; border-collapse: collapse;font-size:11px;">
      <thead>
        <tr style="position: sticky; top: 0; z-index: 1;font-size: 10px;background-color:#FF3CAC">
          <th><button class="btn-close" type="button"
          onclick="
