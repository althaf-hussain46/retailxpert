...
<div class="" style="margin-left:1160px;border:1px solid black;width:340px;height:140px;margin-top:10px;">
                ...
                <div style="display:flex;gap:10px;">
                    <div class="form-floating">
                        <input type="text" name="salesNumber" id="salesNumber" readonly class="form-control" placeholder="Bill Number" value="<?php echo $sales_no; ?>" autocomplete="off"  maxlength="30">
                        <label for="salesNumber" style="margin-left:6px;margin-top:12px;font-size:large;font-weight:bold">Bill Number</label>
                    </div>          
                    <div class="form-floating">
                        <input type="date" name="salesDate" readonly id="salesDate" class="form-control" placeholder="Bill Date " value=""  maxlength="30">
                ...
                <div style="display: flex;">
                  ...
                  <div style="display: flex;margin-left:25px;margin-top:18px;gap:4px">
                    ...
                    <input type="checkbox" name="printSales" id="printSales" value="printBill" checked style="width:20px;height:20px;margin-top:8px;">          
                  </div>
...
<div style="display:flex;gap:12px">
        ...
        <input type="text" name="customerName" autocomplete="off" id="customerName"  class="form-control" placeholder="Press F2 For Customer Info" value="<?php echo $resultSearchCustomerId['customer_name']; ?>">
        ...
        <input type="text" style="width:280px;height:30px;margin-top:-80px;" name="customerMobile" placeholder="Press F2 For Mobile Info" autocomplete="off" id="customerMobile" maxlength="10" class="form-control" value="<?php echo $resultSearchCustomerId['mobile']; ?>">
                        ...
                        <div class="form-floating" style="margin-top:-40px;margin-left:180px">
                             <input type="text" style="height: 40px;width:180px" name="rePrintSalesNumber" id="reprintSalesNumber"  class="form-control" placeholder="Reprint Sales Number" autocomplete="off"  maxlength="30">
                            <label for="reprintSalesNumber" style="margin-left:6px;margin-top:-5px;font-size:13px;font-weight:bold">Select Bill Number</label>
                        
                        </div>  
                        <button type="submit" name="reprintButton" id="reprintButton" class="btn btn-success" style="margin-top:-38px;height:39px">Reprint</button>                                    
                    </div>
...
<div class="tab-content mt-2" id="myTabContent">
    ...
    <div style="width:1235px;height:270px;overflow-y:auto;" id="itemTable">
        <table class="table text-white table-dark" style="font-size:11px;border-collapse:collapse;width:100%; text-align:center;">
            <thead>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="design-field" name="design[]" id="design_1" autocomplete="off"
                               style="width:175px; height:25px; text-align:left;" maxlength="30" />
                    </td>
                    <td>
                        <input type="text" class="description-field" name="description[]" id="description_1" autocomplete="off"
                               style="width:430px; height:25px; text-align:left;" maxlength="150" readonly />
                    </td>
                    <td>
                        <input type="text" class="hsnCode-field" name="hsnCode[]" id="hsnCode_1" autocomplete="off"
                    ...
                    <td>
                        <input type="text" class="sellingPrice-field" name="sellingPrice[]" id="sellingPrice_1" autocomplete="off"
                               style="width:70px; height:25px; text-align:right;" maxlength="12" readonly />
                    </td>
                    <td>
                        <input type="text" class="salesMan-field" name="salesMan[]" id="salesMan_1" autocomplete="off"
                    ...
                    <td>
                        <input type="text" class="discountPercent-field" name="discountPercent[]" id="discountPercent_1" autocomplete="off"
                               style="width:45px; height:25px; text-align:center;" maxlength="4" />
                    </td>
                    <td>
                        <input type="text" class="discountAmount-field" name="discountAmount[]" id="discountAmount_1" autocomplete="off"
                    ...
                    <td hidden>
                        <input type="text" class="actualAmount-field" name="actualAmount[]" id="actualAmount_1" autocomplete="off"
                    ...
                    <td hidden>
                        <input type="text" class="taxable-field" name="taxable[]" id="taxable_1" autocomplete="off"
                    ...
                    <td hidden>
                        <input type="text" class="taxAmount-field" name="taxAmount[]" id="taxAmount_1" autocomplete="off"
...
<div style="display:flex;margin-top:-55px;margin-left:-11px;gap:2px">
<label for="">Dis %</label>
...
<input type="text" name="deductionAmount" id="deductionAmount" autocomplete="off" class="form-control" style="text-align:right;font-size:13px;height:25px;width:90px;"  maxlength="12">
</div>

<div style="display:flex;margin-top:5px;">

<label for="" style="margin-left: -11px;">Add On</label>
<input type="text" name="addOnAmount" id="addOnAmount" autocomplete="off" class="form-control" style="text-align:right;font-size:13px;height:25px;width:90px;margin-left:40px" maxlength="12">
</div>

<div style="display:flex;margin-top:5px">
<label for="" style="margin-left:-11px;">After Add On</label>
<input type="text" name="" id="" class="form-control"  readonly style="font-weight:bold;color:red;text-align:right;font-size:12px;height:25px;width:90px;margin-left:1px" maxlength="12">
</div>
<div style="display:flex;margin-top:5px">
<label for="" style="margin-left:-11px;color:red;">Sales Return</label>
<input type="text" name="salesReturnNetAmount" id="salesReturnNetAmount" class="form-control"  readonly style="font-weight:bold;color:red;text-align:right;font-size:12px;height:25px;width:90px;margin-left:8px" maxlength="12">
</div>

<div style="display:flex;margin-top:5px;">
<label for="" style="margin-left: -11px;color:green;font-size:15px;font-weight:bolder;margin-top:2px">Net Amount</label>
<input type="text" name="netAmount" id="netAmount" class="form-control"  readonly style="font-weight:bolder;color:green;text-align:right;font-size:15px;height:30px;width:90px;margin-left:8px" maxlength="12">
    ...
    <div style="width:1235px;height:270px;overflow-y:auto;" id="itemTable">
        <table class="table text-white table-dark" style="font-size:11px;border-collapse:collapse;width:100%; text-align:center;">
            ...
            <tbody class="sr_items" id="sr_table_body">
                <tr>
                    <td>
                        <input type="text" class="sr_serial-field" name="sr_serialNumber[]" id="sr_serialNumber_1" 
                               style="width:45px; height:25px; text-align:center;" maxlength="4" autocomplete="off" value="1" readonly />
                    </td>
                    <td>
                        <input type="text" class="sr_design-field" name="sr_design[]" id="sr_design_1" autocomplete="off"
                               style="width:175px; height:25px; text-align:left;" maxlength="30" />
                    </td>
                    <td>
                        <input type="text" class="sr_description-field" name="sr_description[]" id="sr_description_1" autocomplete="off"
                               style="width:430px; height:25px; text-align:left;" maxlength="150" readonly />
                    </td>
                    <td>
                        <input type="text" class="sr_hsnCode-field" name="sr_hsnCode[]" id="sr_hsnCode_1" autocomplete="off"
                               style="width:65px; height:25px; text-align:center;" maxlength="8" readonly />
                    </td>
                    <td>
                        <input type="text" class="sr_tax-field" name="sr_tax[]" id="sr_tax_1" autocomplete="off"
                               style="width:35px; height:25px; text-align:center;" maxlength="8" readonly />
                    </td>
                    <td>
                        <input type="text" class="sr_sellingPrice-field" name="sr_sellingPrice[]" id="sr_sellingPrice_1" autocomplete="off"
                               style="width:70px; height:25px; text-align:right;" maxlength="12" readonly />
                    </td>
                    <td>
                        <input type="text" class="sr_salesMan-field" name="sr_salesMan[]" id="sr_salesMan_1" autocomplete="off"
                               style="width:70px; height:25px; text-align:center;" maxlength="12" />
                    </td>
                    <td>
                        <input type="text" class="sr_qty-field" name="sr_qty[]" id="sr_qty_1" autocomplete="off"
                               style="width:35px; height:25px; text-align:center;" maxlength="5" />
                    </td>
                    <td>
                        <input type="text" class="sr_discountPercent-field" name="sr_discountPercent[]" id="sr_discountPercent_1" autocomplete="off"
                               style="width:45px; height:25px; text-align:center;" maxlength="4" />
                    </td>
                    <td>
                        <input type="text" class="sr_discountAmount-field" name="sr_discountAmount[]" id="sr_discountAmount_1" autocomplete="off"
                               style="width:80px; height:25px; text-align:right;" maxlength="10" />
                    </td>
                    <td>
                        <input type="text" class="sr_amount-field" name="sr_amount[]" id="sr_amount_1" autocomplete="off"
                               style="width:85px; height:25px; text-align:right; background-color:#212529; color:white; border:1px solid white;" maxlength="13" readonly />
                    </td>
                    <td hidden>
                        <input type="text" class="sr_actualAmount-field" name="sr_actualAmount[]" id="sr_actualAmount_1" autocomplete="off"
                               style="width:80px; height:25px; text-align:right; background-color:#212529; color:white; border:1px solid white;" maxlength="13" readonly />
                    </td>
                    <td hidden>
                        <input type="text" class="sr_taxable-field" name="sr_taxable[]" id="sr_taxable_1" autocomplete="off"
                               style="width:50px; height:25px; text-align:right; background-color:#212529; color:white; border:1px solid white;" maxlength="13" readonly />
                    </td>
                    <td hidden>
                        <input type="text" class="sr_taxAmount-field" name="sr_taxAmount[]" id="sr_taxAmount_1" autocomplete="off"
                               style="width:10px; height:25px; text-align:right; background-color:#212529; color:white; border:1px solid white;" maxlength="13" readonly />
                    </td>
                    <td>
                        <input type="text" class="sr_id-field" name="sr_id[]" id="sr_id_1" readonly autocomplete="off"
                               style="width:50px; height:25px; text-align:center; background-color:#212529; color:white; border:1px solid white;" />
                    </td>
                </tr>
            </tbody>
        ...
        <div style="margin-left:1180px;margin-top:-45px">
            <div style="display:flex;gap:8px">
            <label for="" style="margin-left:-12px">Total</label>
            <input type="text" name="sr_totalQty" id="sr_totalQty" class="form-control" readonly style="text-align:right;font-size:13px;height:25px;width:50px;" maxlength="4">
            <input type="text" name="sr_totalAmount" id="sr_totalAmount" class="form-control" readonly style="text-align:right;font-size:13px;height:25px;width:90px;margin-left:-5px" maxlength="12">
            ...
            <div style="display:flex;margin-top:-25px;margin-left:180px">
            <label for="">CGST</label>
            <input type="text" name="sr_cgstAmount" readonly id="sr_cgstAmount" autocomplete="off" class="form-control" style="text-align:right;font-size:13px;height:25px;width:90px;margin-left:10px" maxlength="12">
            </div>
            <div style="display:flex;margin-top:5px;margin-left:180px">
            <label for="">SGST</label>
            <input type="text" name="sr_sgstAmount" readonly id="sr_sgstAmount" autocomplete="off" class="form-control" style="text-align:right;font-size:13px;height:25px;width:90px;margin-left:10px" maxlength="12">
            </div>
            <div style="display:flex;margin-top:5px;margin-left:180px">
            <label for="">IGST</label>
            <input type="text" name="sr_igstAmount" readonly id="sr_igstAmount" autocomplete="off" class="form-control"  style="text-align:right;font-size:13px;height:25px;width:90px;margin-left:15px" maxlength="12">
            </div>
            ...
            style="width:51px;height:25px">
            <!-- <label for="">Discount </label> -->
            <input type="text" name="sr_deductionAmount" id="sr_deductionAmount" autocomplete="off" class="form-control" style="text-align:right;font-size:13px;height:25px;width:90px;"  maxlength="12">
            </div>
            
            <div style="display:flex;margin-top:5px;">
            
            <label for="" style="margin-left: -11px;">Add On</label>
            <input type="text" name="sr_addOnAmount" id="sr_addOnAmount" autocomplete="off" class="form-control" style="text-align:right;font-size:13px;height:25px;width:90px;margin-left:40px" maxlength="12">
            </div>
            
            
            <div style="display:flex;margin-top:5px;">
            <label for="" style="margin-left: -11px;color:red;font-size:15px;font-weight:bolder;margin-top:2px">Net Amount</label>
            <input type="text" name="sr_netAmount" id="sr_netAmount" class="form-control"  readonly style="font-weight:bolder;color:red;text-align:right;font-size:15px;height:30px;width:90px;margin-left:8px" maxlength="12">
...
function sr_calculateAc(){
    ...
    let sr_differencePercentage = (parseFloat(parseFloat(sr_differenceAmount)/parseFloat(sr_actualTotalAmount))*100).toFixed(2);
    ...
    for(let i=1;i<=sr_total_rows;i++){
        ...
        // eachRowActualAmountAfterDiscount = (parseFloat(eachRowActualAmount)-((parseFloat(eachRowActualAmount)*parseFloat(differencePercentage))/100)).toFixed(2)
        sr_eachRowActualAmountAfterDiscount = (parseFloat(sr_eachRowActualAmount) - parseFloat(((parseFloat(sr_eachRowActualAmount) * parseFloat(sr_differencePercentage)) / 100))).toFixed(2);
            
        console.log("sr_actual after discount = ",sr_eachRowActualAmountAfterDiscount)
        
        // eachRowTaxableAmount = ((parseFloat(eachRowActualAmountAfterDiscount)/parseFloat(eachRowTaxPercentage2+100))*100).toFixed(2)    
        sr_eachRowTaxableAmount = ((parseFloat(sr_eachRowActualAmountAfterDiscount) / parseFloat(parseFloat(sr_eachRowTaxPercentage2) + 100)) * 100).toFixed(2);
        console.log("sr_taxable amount  after discount = ",sr_eachRowTaxableAmount)
        
        // eachRowTaxAmount = ((parseFloat(eachRowTaxableAmount)*parseFloat(eachRowTaxPercentage2))/100).toFixed(2)
        sr_eachRowTaxAmount = ((parseFloat(sr_eachRowTaxableAmount) * parseFloat(sr_eachRowTaxPercentage2)) / 100).toFixed(2);
        ...
        sr_totalTaxable = parseFloat(sr_totalTaxable)+parseFloat(document.getElementById("sr_taxable_"+i).value||0);
        sr_totalTaxAmount = parseFloat(sr_totalTaxAmount)+parseFloat(document.getElementById("sr_taxAmount_"+i).value||0);
...
function sr_calculateTaxAmount(target){
    ...
    sr_taxAmount.value = (parseFloat(sr_amount) - ((parseFloat(sr_amount) / (parseFloat(sr_truncatedTax) + 100))) * 100).toFixed(2);
...
function sr_calculateNetDiscountPercent(){
        ...
        sr_netDiscountPercent.value  = (parseFloat((parseFloat(sr_netDiscountAmount)/parseFloat(sr_totalAmount))*100)).toFixed(2);
        sr_calculateNetAmount();
